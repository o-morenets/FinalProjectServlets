...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header"><fmt:message key="card.ratingList.title"/></div>
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th><fmt:message key="userList.link.averageGrade"/></th>
                    </tr>
                    </thead>
                    <tbody>
                            ...
                            <td>
                                <c:if test="${!empty user.message}">
                                    <div class="progress">
                                        ...
                                        <c:choose>
                                            <c:when test="${user.message.entered}">bg-success</c:when>
                ...
                <nav aria-label="Navigation for users">
                    <ul class="pagination">
                        <c:if test="${currentPage != 1}">
                            <li class="page-item">
                                <a class="page-link"
                                   href="${pageContext.request.contextPath}${requestScope[Attributes.SERVLET_PATH_API]}${Paths.USERS_RATING_LIST}?recordsPerPage=${recordsPerPage}&currentPage=${currentPage - 1}">
                        ...
                        <c:forEach begin="1" end="${noOfPages}" var="i">
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <li class="page-item">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}${requestScope[Attributes.SERVLET_PATH_API]}${Paths.USERS_RATING_LIST}?recordsPerPage=${recordsPerPage}&currentPage=${i}">
                                                ${i}
                                        </a>
                                    </li>
                                </c:otherwise>
                        ...
                        <li>
                            <form action="${pageContext.request.contextPath}${requestScope[Attributes.SERVLET_PATH_API]}${Paths.USERS_RATING_LIST}?recordsPerPage=${recordsPerPage}&currentPage=${currentPage}">
