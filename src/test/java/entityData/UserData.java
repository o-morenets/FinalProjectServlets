...
public enum UserData {
    ...
    Z(2L, "iryna.zaychenko@ua", "Ірина", "Зайченко",
            "fbade9e36a3f36d3d676c1b808451dd7", "z", Collections.singleton(Role.USER), SpecialityData.SP_2),
    X(3L, "kateryna.osadcha@ua", "Катерина", "Осадча",
            "9dd4e461268c8034f5c8564e155c67a6", "x", Collections.singleton(Role.USER), SpecialityData.SP_3),
    Q(4L, "alla.shurova@ua", "Алла", "Шурова",
            "7694f4a66316e53c8cdd9d9954bd611d", "q", Collections.singleton(Role.USER), SpecialityData.SP_1),
    ...
    W(6L, "serhii.zhdanov@ua", "Сергій", "Жданов",
            "f1290186a5d0b1ceab27f4e77c0c5d68", "w", Collections.singleton(Role.USER), SpecialityData.SP_4),
    ...
    UserData(Long id, String email, String firstName, String lastName,
             String password, String username, Set<Role> roles, SpecialityData specialityData) {
        ...
        user = User.builder()
                ...
                .username(username)
                .roles(roles)
                .speciality(specialityData == null ? null : specialityData.speciality)
                .build();
    }
}
